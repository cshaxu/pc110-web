...
| M3: Usable Web MVP | Canvas UI, asset import, session controls, runtime-contract extraction, and minimal persistence | Personaware and Easy-Setup regressions, error and refresh/recovery verification |
