...
| Active | M3 T5 S2 P1 wasm32 Safari 26 compatibility path | `history/M3-T5-S2-P1-wasm32-safari26-compatibility.md` | Isolated wasm32 clean build, module import, and browser boot evidence |
