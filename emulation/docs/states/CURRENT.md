...
**Status: Verified — M3 T2 S1 P1 closed.** The independent Windows-native
clean build now produces and browser-boots a PC110-enabled WASM artifact while
preserving the local-media and no-redistribution boundary. The next admission
may design the application and emulator-adapter split.
