...
- `web/docs/README.md` is the sole entry point, and every subject has one current authority.
- `web/docs/design/` contains current product design; `web/docs/rules/` contains rules; `web/docs/states/` contains only the operational control plane.
